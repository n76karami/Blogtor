        ...
        <div className='absolute top-[calc(50vh-37%)] lg:left-[calc(50vw-35%)] left-[calc(50vw-45%)] flex flex-col
          ...
          <div className="my-5 grid md:grid-cols-3 place-items-center">
            ...
            <div className="mx-auto md:ml-[-10px] ">
              <h1 className="text-center md:text-left px-5 py-2">{writer.username}</h1>
              <p className="text-center md:text-left px-5 py-2">{writer.name}</p>
              <p className="text-center py-2 break-words">{writer.bio ? writer.bio : "No bio has been entered yet!"}</p>
            </div>
